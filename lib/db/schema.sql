-- LegacyChain schema (Neon / PostgreSQL)
--
-- PRIVACY MODEL: this database holds the family's private content —
-- stories, names, locations, file references. Only hashes and anchors
-- ever reach the public blockchain. Nothing here is written on-chain.
...
-- A heritage item's fingerprint is looked up on every verification.
